 ...
 */
public class ChurnOMLExplanation {
    private static final Logger LOGGER = LoggerFactory.getLogger(ChurnOMLExplanation.class);


    public static void main(String[] args) throws IOException {
        // Load dataset and its description
        final AnchorTabular anchorTabular = ChurnOMLDataset.createTabularTrainingDefinition();
        ...
        h2oBuilder.setTau(0.8).setBeamSize(10);
    ...
    private static void outputTestsetAccuracy(String name, Function<TabularInstance, Integer> predictFunction) {
        final TabularInstance[] testData = ChurnOMLDataset.createTabularTestDefinition().getTabularInstances();
        final int[] actualTestLabels = ChurnOMLDataset.readTestLabels();
        int matches = 0;
