 ...
 */
public class ChurnKaggleExplanation {
    private static final Logger LOGGER = LoggerFactory.getLogger(ChurnKaggleExplanation.class);


    public static void main(String[] args) throws IOException {
        // Load dataset and its description
        final AnchorTabular anchorTabular = ChurnKaggleDataset.createTabularTrainingDefinition();
        ...
        h2oBuilder.setTau(0.7).setBeamSize(5);
    ...
    private static void outputTestsetAccuracy(String name, Function<TabularInstance, Integer> predictFunction) {
        final TabularInstance[] testData = ChurnKaggleDataset.createTabularTestDefinition().getTabularInstances();
        final int[] actualTestLabels = ChurnKaggleDataset.readTestLabels();
        int matches = 0;
