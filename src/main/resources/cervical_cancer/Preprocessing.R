...
setwd("C:\\Users\\GoT\\Documents\\git\\xai_examples\\src\\main\\resources\\cervical_cancer")
data.table::fwrite(get.cervical.data("C:\\Users\\GoT\\Documents\\git\\xai_examples\\src\\main\\resources\\cervical_cancer"), "cervical_cancer_preprocessed.csv")
